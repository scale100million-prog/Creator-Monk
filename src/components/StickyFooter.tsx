    ...
    >
      ...
      <div className="flex flex-col text-left justify-center flex-shrink-0">
        <div
          ...
          className="text-[#F5E6A3] font-bold text-[24px] md:text-[32px] leading-none tracking-[-0.01em] select-none font-sans"
        >
      ...
      <div className="relative flex items-center flex-shrink-0">
        ...
        >
          <span className="w-[6px] h-[6px] rounded-full bg-[#F5E6A3] inline-block flex-shrink-0" />
        ...
        <button
          ...
          type="button"
          onClick={openModal}
          className="inline-flex items-center justify-center font-semibold text-[15px] sm:text-[16px] text-[#0A0A0A] bg-[#FFFFFF] rounded-full cursor-pointer select-none text-center py-[12px] sm:py-[14px] md:py-[16px] px-[24px] sm:px-[32px] md:px-[40px] min-h-[44px] md:min-h-[48px] shadow-[0_4px_16px_rgba(0,0,0,0.4)] hover:bg-[#F5E6A3] hover:scale-[1.02] active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-[#F5E6A3] focus-visible:outline-offset-2 transition-all duration-200 ease-out whitespace-nowrap"
        >
          Apply Now
        </button>
      </div>
